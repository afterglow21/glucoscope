...
const SOURCE_DEFINITIONS = Object.freeze({
  ...
  libre: Object.freeze({
    ...
    note: "一般利用者向け限定中継とは別の公開デモWorkerで、公開3CGMライブデモを継続中です。接続情報は公開されません。約3時間の継続稼働を確認しました。開いたままの既存ブラウザタブでも、約5分後の自動更新を別の機会にもう1回確認し、これまでの確認は合計2回になりました。表示エラーはありませんでした。正常な5分更新中は、成功するたびにKVの最長36時間の期限が更新されるため、自然失効は起きません。自然失効は、更新が止まった場合の別の安全確認として扱い、公開継続の妨げにはしません。",
  }),
...
const VERIFIED_DEXCOM_DEFINITION = Object.freeze({
  ...
  note: "Kazumaが公開を選んだDexcom G7の直近データです。公開3CGMライブデモを継続中で、約3時間の継続稼働を確認しました。開いたままの既存ブラウザタブでも、約5分後の自動更新を別の機会にもう1回確認し、これまでの確認は合計2回になりました。表示エラーはありませんでした。接続情報は公開されません。正常な5分更新中は、成功するたびにKVの最長36時間の期限が更新されるため、自然失効は起きません。自然失効は、更新が止まった場合の別の安全確認として扱い、公開継続の妨げにはしません。",
});
