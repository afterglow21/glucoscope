...
The public site is served by GitHub Pages at `https://glucoscope.app/`. The custom domain is verified and HTTPS is enforced. Commit `64a92932a592dda1b6eb9d6dd7700279b1c7a47a` records the base long-lived-session release; current accepted frontend and iPhone Home Screen evidence is recorded through commit `746116043b8d7ad0ad60c8af5eb27ad4d661d94d`.
...
The current AI Worker new-origin checkpoint is Version `7ea0cfef-5322-4370-b72d-e2885f129f38` at 100%. Historical Version 29 (`235cdf03-31d7-40fd-ab58-5c1c6aa2d923`) and deployment `a5b57a76-954b-4bb9-bbba-c23bfd0fa516` record the earlier personal-user AI boundary release. Personal-user AI remains enabled for the small early-access group under the boundary below.
...
- GitHub Pages serves the accepted frontend through commit `746116043b8d7ad0ad60c8af5eb27ad4d661d94d`.
- AI Worker new-origin Version `7ea0cfef-5322-4370-b72d-e2885f129f38` receives 100% of AI traffic. Version 29 is historical acceptance evidence, not the current traffic target.
- Usage Worker Version `137ee815-ecf3-4e5a-856a-44eeda8b6eff` receives 100% of Usage traffic for the approved small early-access group. The checked-in configuration remains fail-closed.
