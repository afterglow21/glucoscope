...
8. Current: keep the general-user relay stopped pending a separate continuing-enablement decision. Natural ticket expiry, persistence after fully quitting Safari, and live request-limit exhaustion remain outside the accepted evidence.
