...
The public site is served by GitHub Pages at `https://glucoscope.app/`. The custom domain is verified and HTTPS is enforced. Commit `7badb3ad0110ca45750bb3d04786d40a5f015285` is the accepted full gentle-letter Share Studio and retained one-trial-AI checkpoint. Commit `96da92df9a47c994cbb3c031d65cba9fbf5daea8` records the small public Plus release and approved hourly cleanup schedule, commit `7836b2f0ec3574890e25e4edc1dd9d128ba670d8` remains the accepted atomic usage-counter source checkpoint, and commit `64a92932a592dda1b6eb9d6dd7700279b1c7a47a` records the base long-lived-session release. Accepted frontend and iPhone Home Screen evidence is recorded through commit `746116043b8d7ad0ad60c8af5eb27ad4d661d94d`.
...
- GitHub Pages publishes from `main`. Commit `7badb3ad0110ca45750bb3d04786d40a5f015285` is the accepted full gentle-letter Share Studio and retained one-trial-AI checkpoint. Atomic-counter and iPhone Home Screen acceptance remain recorded by the earlier checkpoints above.
...
- On 2026-08-23, a real Plus purchase passed JPY 400 one-time Checkout, entitlement start, reload persistence, visible expiry/no-renewal notice, the 7-day, 30-day, and custom graph ranges, detailed analysis, and Stripe receipt delivery. The first Share Studio reliability sample produced a valid four-image set but also showed two failed attempts in five, so the first public announcement remains held. AI Worker Version `d24ac75d-7399-4b2c-a308-35c797f2c998` and Usage Worker Version `d8c67ed3-806d-40c5-97d2-fcec58b18749` now separate Plus regular AI and Plus Share Studio into two authoritative allowances of five successful new analyses per JST day. Failed work and saved local displays do not count. No personal expiry, email, payment reference, card information, glucose value, or generated text is recorded here.
