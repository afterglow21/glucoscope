...
The reviewed personal-quota AI Worker target is Version `5b0a2593-ec64-4c7e-9129-60e0deb51762`. Its direct behavior rollback is Version `ef238ad4-7dc7-4b79-bb92-b9c93605c6c3`. The current target keeps the atomic counter, personal quota, signed administrator bridge, no separate administrator daily count cap, and exact-reservation Share Studio gentle analysis active while adding one bounded final Share Studio rewrite. Atomic stopped Version `46f44888-002b-4847-8553-5cd12e3d7ac5` remains the emergency AI-off target. Historical Version 29 (`235cdf03-31d7-40fd-ab58-5c1c6aa2d923`) records the earlier personal-user AI boundary release. Personal-user AI remains enabled for the small early-access group under the boundary below.
...
- AI Worker Version `5b0a2593-ec64-4c7e-9129-60e0deb51762` receives 100% of AI traffic with atomic personal quota, the signed administrator bridge, no separate administrator daily count cap, exact-reservation Share Studio gentle analysis, and one bounded final Share Studio rewrite. Version `ef238ad4-7dc7-4b79-bb92-b9c93605c6c3` is the direct behavior rollback; emergency AI-off recovery uses atomic stopped Version `46f44888-002b-4847-8553-5cd12e3d7ac5`. Version 29, the old `7ea0cfef-5322-4370-b72d-e2885f129f38`, Phase A, and pre-atomic Versions must not receive rollback traffic.
- Usage Worker Version `93b5a9ce-b9cc-47ca-9aed-d8d2dc772ab7` receives 100% of Usage traffic with the reviewed Plus-entitlement service binding, retained verified-email trial identity, exact Share Studio trial reservation context, and an independent one-use trial AI allowance that does not consume or depend on the ordinary Free daily allowance. Version `e745f53a-aea0-427e-8421-278d3549e30d` is the direct behavior rollback. D1 migration `0002_ai_quota.sql` is applied, and the checked-in configuration remains fail-closed.
...
- On 2026-08-23, a real Plus purchase passed JPY 400 one-time Checkout, entitlement start, reload persistence, visible expiry/no-renewal notice, the 7-day, 30-day, and custom graph ranges, detailed analysis, and Stripe receipt delivery. The first Share Studio reliability sample produced a valid four-image set but also showed two failed attempts in five, so the first public announcement remains held. AI Worker Version `5b0a2593-ec64-4c7e-9129-60e0deb51762` now gives exact Share Studio requests one final bounded content rewrite. The matching Pages candidate makes the expiry visually prominent and shows the authoritative shared successful-analysis count as `used / 5`; it still requires one iPhone retest before the first announcement. Normal AI and Share Studio share the same five successful new analyses per JST day; failed work and saved local displays do not count. No personal expiry, email, payment reference, card information, glucose value, or generated text is recorded here.
