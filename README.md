...
- On 2026-08-17, Stripe test mode created one active `GlucoScope Plus 30日パス` Product with one default JPY 400 one-time Price. No recurring Price, Checkout, payment, API key, webhook Secret, route, or sale was enabled.
