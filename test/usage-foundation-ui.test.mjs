...
test("staged usage sharing is visible as preparation but cannot invite or transmit yet", () => {
...
test("local display-name storage remains network-free and server sync is separate", () => {
  ...
  assert.match(index, /js\/usage-client\.js\?v=20260811-usage-profile-stage-1/);
