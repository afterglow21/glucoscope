...
同日、初期販売のアカウント境界候補を「18歳以上で、本人が購入、メール確認、別端末への復旧、
問い合わせを自分で管理でき、本人だけが使うメール1つを1アカウントに使う人」として記録しました。
これは販売上の行き違いを減らすための安全側の候補で、運営者本人の承認前です。
18歳未満、保護者が子どもの代わりに購入・復旧する使い方、兄弟姉妹・家族・学校・施設・職場などの
共用メールは、専用の保護者・家族機能が完成するまでPlus販売の対象にしません。保護者のメール1つへ
複数の子どもを結び付けると、同意、復旧、Plus利用権、AI回数、Share Studio無料体験を子どもごとに
分けられないためです。子ども向けPlusを再検討する時は、保護者と子どもの役割、子どもごとの同意・
利用権・回数・体験、復旧と解除を分けた専用仕様を先に受け入れます。初期版では生年月日を集めず、
血糖情報、表示名、CGMの種類から年齢や本人管理の可否を推測しません。購入対象外でもFreeの現在血糖と
基本グラフを止めません。
